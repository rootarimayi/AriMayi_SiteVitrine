...
export default function Header() {
    ...
    const getButtonClass = (path) => {
        if ((path === '/partenaires' || path === '/apprenants') && pathname === path) {
    ...
    return (
        <>
            <header className={`overflow-hidden fixed z-50 w-full ${isOpen ? 'bg-white' : 'bg-[#292929]'}`}>
                <div className={`relative py-[10px] ${isOpen ? 'bg-white' : 'bg-[#292929]'}`}>
                    <div className="container flex items-center justify-between gap-2">
                        <div className="flex items-center">
                            <div className="flex-shrink-0">
                        ...
                        <div className="hidden lg:flex items-center gap-5">
                            <nav className="ml-4 flex items-center">
                                ...
                                <div className="flex items-center gap-4 mr-20">
                                    <Link
                                        href="/partenaires"
                                        className={getButtonClass('/partenaires')}
                                    >
                                        Partenaires
                                    </Link>
                                    <Link
                                        href="/apprenants"
                                        className={getButtonClass('/apprenants')}
                                    >
                                        Apprenants
                                    </Link>
                                </div>
