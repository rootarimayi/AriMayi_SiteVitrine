        ...
        await transporter.sendMail({
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #eaeaea; padding: 20px; border-radius: 8px; background-color: #ffffff;">
              <div style="text-align: center; padding-bottom: 15px; border-bottom: 2px solid #f2f2f2;">
                ...
                <ul>
                    <li>✔️ Des ressources et conseils pour développer vos compétences, que vous soyez en apprentissage ou en plein lancement de projet.</li>
                    <li>✔️ Des opportunités et mises en relation pour apprendre, entreprendre et bâtir un avenir qui vous ressemble.</li>
                    <li>✔️ Les coulisses de la fourmilière AriMayi, avec nos initiatives solidaires et nos engagements pour une réussite accessible à tous.</li>
                    <li>✔️ Des témoignages inspirants de celles et ceux qui osent, construisent et tracent leur propre chemin.</li>
                </ul>
        
                <p>Dans la fourmilière AriMayi, chaque action compte et ensemble, nous pouvons soulever des montagnes 💪 !</p>
        
                <p>Nous avons hâte de partager cette belle aventure avec vous. En attendant, suivez-nous sur <a href="[remplacer par vos vrais liens]">nos réseaux sociaux</a> et échangeons ensemble !</p>
        
                <p>À très bientôt dans la fourmilière 🚀🐜</p>
                <p>L'équipe AriMayi</p>
                <p>Sur LinkedIn : <a href="https://www.linkedin.com/company/arimayi/">LinkedIn</a><br />
                Sur Instagram : <a href="https://www.instagram.com/arimayi___">Instagram</a><br />
                Sur TikTok : <a href="https://www.tiktok.com/@arimayi_">TikTok</a></p>
