    ...
    <>
      <Banner className="bg-HomepageBanner min-h-[700px] pl-[50px] ">
        ...
        <div className="buttons flex gap-4">
          ...
          <CostumButton text="Découvrez nous Formations" classes="font-Opensans text-[20px]  bg-orange text-white  hover:scale-110 mx-[10px]" src="/formations" />
        </div>
      </Banner>
      {/**************** arimayi Section  ***********/}
      <section className="arimayi pt-[50px]">
        <div className="container">
          ...
          <div>
            ...
            <div className="flex justify-start pt-[50px] pr-[10px]">
              <div className="bg-bgAri w-[50%]">
                <Image src={happyness} alt="happyness" />
              </div>
              <div className="w-[25%]">
                <p className="font-Opensans text-[16px] leading-[25px] text-black my-[10px]">
                  Inspiré des mots japonais Ari et chinois Mǎyǐ, signifiant "fourmi", ARIMAYI a choisi cet animal pour incarner ses valeurs essentielles.
                  <br />
                ...
                <CostumButton text="Découvrez plus sur nous" classes="font-Opensans text-[20px]  bg-orange text-white  hover:scale-110 mx-[10px] my-[10px]" src="/identite" />
              </div>
            </div>
          </div>
